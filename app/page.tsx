...
const basePath = '/cnno-1775721353850';
...
export default function Home() {
  ...
  const products = [{ n: 'Classic Cinnamon Rolls', d: 'Indulge in our signature OG Rolls, carefully crafted with the finest ingredients and a hint of cinnamon, perfect for satisfying your sweet tooth. Each roll is baked fresh to ensure a soft, fluffy texture and an irresistible aroma.', i: 'https://images.pexels.com/photos/30666844/pexels-photo-30666844.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'domain' }, { n: 'Pistachio Delights', d: 'Experience the unique flavor of our Pistachio Rolls, infused with the nutty taste of pistachios and a touch of sweetness. These rolls are perfect for those looking to try something new and exciting.', i: 'https://images.pexels.com/photos/36835363/pexels-photo-36835363.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'architecture' }, { n: 'Decadent Chocolate Rolls', d: 'Treat yourself to our rich and indulgent Chocolate Rolls, filled with a velvety chocolate filling and topped with a layer of creamy goodness. These rolls are a chocolate lover\'s dream come true.', i: 'https://images.pexels.com/photos/7916094/pexels-photo-7916094.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'chair' }, { n: 'Baby Rolls', d: 'Enjoy our bite-sized Baby Rolls, perfect for snacking on the go or as a sweet treat for any time of day. These adorable rolls are filled with the same love and care as our larger rolls, but in a smaller, more convenient package.', i: 'https://images.pexels.com/photos/5507697/pexels-photo-5507697.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'eco' }, { n: 'Party Box', d: 'Share the joy of CNNO with our Party Box, featuring a selection of our signature rolls and perfect for special occasions or gatherings. This box is a great way to impress your friends and family with a delicious and unique treat.', i: 'https://images.pexels.com/photos/29349525/pexels-photo-29349525.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', icon: 'precision_manufacturing' }];
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-8 pt-8">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-on-surface-variant">To craft artisanal sweet rolls that bring warmth and comfort to our community, while fostering a culture of quality, creativity, and exceptional customer experience.</p>
                </div>
                <div className="space-y-2">
